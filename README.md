# Lactalis Corporate Affairs Intelligence System

Automated daily monitoring of regulatory, nutrition, dairy-industry, sustainability, and public-affairs sources — analyzed for Lactalis USA communications relevance and delivered by email and a web dashboard.
...
3. **The push triggers [`.github/workflows/email.yml`](.github/workflows/email.yml)**, which emails the daily brief (and Monday weekly briefing) to `jade.ritchie@us.lactalis.com` via Gmail SMTP.
